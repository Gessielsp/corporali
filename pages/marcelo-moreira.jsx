        ...
        <div className={robotoCondensed.className}>
            ...
            <div id={styles.vidaMarcelo}>
                ...
                <div id={styles.arteDeConstruir}>
                    <div className={styles.boxSegundaSessao}>
                        ...
                        <p className={styles.descricaoSegundaoSessao}>Dr. Marcelo Moreira é conhecido por sua paixão em restaurar a confiança e a qualidade de vida de seus pacientes. Seu dia a dia é uma jornada dedicada à reconstrução, seja restaurando a função abdominal, a estética facial, a integridade de tecidos ou a beleza mamária. Cada cirurgia é uma oportunidade de transformar vidas.</p>
                    </div>
            ...
            <div id={styles.galeriaFotosMarcelo}>
                <div>
                    ...
                    <p id={styles.descricaoGaleria}>Esta galeria de fotos oferece uma visão cativante da jornada notável do Dr. Marcelo Moreira na pesquisa biomédica e suas atividades beneficentes, capturando momentos de inovação e compaixão ao longo de sua carreira inspiradora.</p>
                </div>
